...
adjust main.cpp line 83-84 and motor_control.cpp line 18-29 by swapping A or B IN1 and IN2 position
*/
...
// 100 (gear ratio) x 7 (magnetic loops/encoder lines) x 4 (quadrature edges)
#define L_ENCODER_CPR 2800
#define R_ENCODER_CPR 2800  
...
// Robot Dimensions
#define WHEEL_RADIUS 0.017  // in meters
#define WHEEL_SEPARATION 0.125  // in meters
